...
### [13] [Strong aggregation of the Markov chains associated with matching models based on the automorphism group of their compatibility graphs](https://arxiv.org/abs/2609.16861)
...
### [14] [Discovering Performance Archetypes: Critical-Path-Aware Pattern Analysis and Regression Detection](https://arxiv.org/abs/2609.17179)
...
### [15] [Automated Comment Moderation Enhances Social Media Advertising Performance](https://arxiv.org/abs/2609.16005)
...
### [16] [Social Behavior Among Autonomous AI: How Large Language Models Interact in Dynamic Networks](https://arxiv.org/abs/2609.16013)
...
### [17] [Digital Persuasion: Understanding the Impact of Online Influencers on Public Opinion](https://arxiv.org/abs/2609.16062)
...
### [18] [Predicting Social Media Engagement using Machine Learning](https://arxiv.org/abs/2609.16082)
...
### [19] [netseg: a Python Package for Measuring Structural Polarization and Segregation in Social Networks](https://arxiv.org/abs/2609.16088)
...
### [20] [On the Expressive Power of Implicit Line-Graph Higher-Order Weisfeiler--Leman](https://arxiv.org/abs/2609.16412)
*Fan Yang*
...
### [21] [Inferring Temporal Dependencies from Social Time Series with the Cross-Correlogram](https://arxiv.org/abs/2609.16633)
...
### [22] [The Local-to-Global AD-k Conjecture is Resolved](https://arxiv.org/abs/2609.16663)
*Wei Chen*
...
### [23] [WCCS: Efficient Wedge Conductance Community Search over Large Temporal Bipartite Graphs (Full Paper)](https://arxiv.org/abs/2609.16882)
...
### [24] [Graphlets as structural fingerprints of complex networks](https://arxiv.org/abs/2609.17445)
...
### [25] [Fast-Convergent Meta-RL via Gradient-Clustered BS Sampling for Edge Caching](https://arxiv.org/abs/2609.16370)
...
### [26] [The Price of the Golden 6G Band: Evaluation of Beam Management Effort in FR3](https://arxiv.org/abs/2609.16839)
...
### [27] [A Mechanical Antenna for Improving Capacity Fairness in Dynamic Multi-Station Scenarios](https://arxiv.org/abs/2609.16877)
...
### [28] [AeroLat: Channel-Aware Latent Space Semantic Communication for Decentralized UAV Swarms](https://arxiv.org/abs/2609.16947)
...
### [29] [Beyond Measurement Metrics: A Human-Centered Framework for Semantic Validation of Network Traffic Classification](https://arxiv.org/abs/2609.17014)
...
### [30] [Agentic RDZ: Autonomous Zone Management with AI Agents and an FR3 Coexistence Use Case](https://arxiv.org/abs/2609.17110)
