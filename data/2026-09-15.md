...
### [1] [Partition-Aware Scheduling for Mobile Heterogeneous Inference Co-Execution](https://arxiv.org/abs/2609.14213)
...
### [3] [Validating Hybrid-State Cache Recovery for GLM-5.3-Flash with vLLM and LMCache](https://arxiv.org/abs/2609.15030)
*Frank Li*
...
### [4] [PEAT: Pseudo-Error Assessment for GPU Kernel Validation in DNN Training](https://arxiv.org/abs/2609.13544)
...
### [5] [The Essence of Git: Concepts for P2P Replication](https://arxiv.org/abs/2609.13555)
*Erick Lavoie*
...
### [7] [OpWeave: Flexible Operator Disaggregation for Heterogeneous LLM Serving](https://arxiv.org/abs/2609.14237)
...
### [9] [DeepSeek-V4-Flash on AMD gfx90a: Correctness Recovery and Inference Performance Engineering](https://arxiv.org/abs/2609.15627)
*Siming Huang*
...
### [10] [Cnuas: A Software-Defined AI/HPC Rack-scale Emulation Platform and Hyperscale Data Center Facility Twin](https://arxiv.org/abs/2609.15889)
...
### [11] [The Interconnectedness Coefficient: A Semi-Local Graph-Theoretic Measure for Connector Vertices between Cohesive Network Regions](https://arxiv.org/abs/2609.13928)
*Thomas Wiebringhaus*
...
### [12] [Enhancing Human Mobility Prediction with Spatially Aware LLM-based Multi-Agent Systems](https://arxiv.org/abs/2609.14227)
...
### [13] [Learning Metastable Dynamics](https://arxiv.org/abs/2609.14712)
...
### [14] [Proportional-Fair Resource Allocation and Dual-Threshold Early-Exit Inference for Secure Cooperative Multi-Layer Edge Intelligence](https://arxiv.org/abs/2609.15847)
