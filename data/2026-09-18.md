...
### [1] [Not All Nodes Are Created Equal: Homophily-Aware Stratification for Stable GNN Evaluation](https://arxiv.org/abs/2609.19210)
...
### [2] [Experienced partisan segregation across patterns of mobility behavior in US cities](https://arxiv.org/abs/2609.19285)
...
### [3] [Finding Common Ground: Graded Communal Knowledge in Bluesky Starter Packs](https://arxiv.org/abs/2609.19549)
...
### [4] [Converging Naming Styles, Persistent Network Locality: GitHub in the LLM Era](https://arxiv.org/abs/2609.19864)
...
### [5] [Competing for a Finite Pool of Attention in Social Media? How a New Geopolitical Conflict Reshapes Engagement in Bluesky](https://arxiv.org/abs/2609.20101)
...
### [6] [An Interpretable Approach to Money Laundering Detection in Transaction Graphs using Pass-Through Templates](https://arxiv.org/abs/2609.20737)
*Paolo Climaco*
...
### [7] [PyStream: Enhancing Video Streaming Evaluation](https://arxiv.org/abs/2609.19823)
...
### [8] [Application-Integrated Slicing towards 6G: The Musical Metaverse Use Case](https://arxiv.org/abs/2609.20163)
...
### [9] [STR-Agent: An LLM-Driven Agent for QoS-Aware Routing in LEO Satellite Networks](https://arxiv.org/abs/2609.20347)
...
### [10] [Value-Based Massive Access through Goal-Oriented Irregular Repetition Slotted ALOHA](https://arxiv.org/abs/2609.20569)
...
### [11] [NS3Learn: Transferring 5G NR Mode-2 Reception Realism from ns-3 to the Veins/SUMO Stack for Connected-Vehicle Safety Assessment](https://arxiv.org/abs/2609.20578)
...
### [12] [RUN-O-RAN: An O-RAN-Native Architecture Enabling Cooperative Uplink Localization](https://arxiv.org/abs/2609.20640)
...
### [13] [Rosetta: Automating First-Principles Performance Modeling Using Multi-Agent LLMs](https://arxiv.org/abs/2609.19376)
...
### [14] [PrefixBench-H100: Characterizing Prefix Reuse and Time-to-First-Token in H100 LLM Serving](https://arxiv.org/abs/2609.19657)
...
### [15] [Whittle index approach to multi-server scheduling with convex delay costs and impatient customers](https://arxiv.org/abs/2609.19792)
*Samuli Aalto*
...
### [16] [Efficiently Distributed Federated Learning](https://arxiv.org/abs/2609.19972)
...
### [17] [Scaling Fourier-Based Sparse Matrix Analysis on GPUs](https://arxiv.org/abs/2609.20483)
...
### [18] [Detecting Soft Errors in Parallel Software with LLM-tuned Instruction Duplication](https://arxiv.org/abs/2609.19531)
...
### [19] [Syndrome Decoding for Silent Data Corruption in Quantized Integer GPU Arithmetic](https://arxiv.org/abs/2609.19743)
...
### [20] [Sketching the Error, Not the Product: Post Hoc Fault Recovery for Half Precision GPU Matrix Multiplication](https://arxiv.org/abs/2609.19758)
*Pranav Napolean,Vikas Srivastava,Napolean Periathambi*
...
### [21] [Safe Exploration of Arbitrary Dynamic Dangerous Networks](https://arxiv.org/abs/2609.19845)
...
### [22] [Xronos: Heterogeneity-Aware Tensor Parallelism for Collaborative LLM Fine-Tuning on Edge CPUs](https://arxiv.org/abs/2609.19909)
...
### [23] [The Life of a Token: from Words to Bits on the Wire](https://arxiv.org/abs/2609.19924)
...
### [24] [VERA: Reinforcement Learning for Dynamic Memory Scaling of HPC Workloads in Kubernetes](https://arxiv.org/abs/2609.19936)
...
### [25] [Accelerating Sharded Data Parallelism at Scale with Federated Learning](https://arxiv.org/abs/2609.20359)
...
### [26] [P-GADMM: Parallel Group-Based ADMM for Asynchronous Optimization in Heterogeneous Edge Networks](https://arxiv.org/abs/2609.20006)
...
### [27] [Distributed Edge Inference: an Experimental Study on Multiview Detection](https://arxiv.org/abs/2609.20009)
...
### [28] [The Price of Decentralization, Paid Twice: A Latency Floor and a Minimal Subsidy from a Geographic Decentralization Invariant](https://arxiv.org/abs/2609.20322)
*Ruiyang Zhang*
...
### [29] [A Kubernetes-Native Request Router for Quality-Aware Inference Serving in the Computing Continuum](https://arxiv.org/abs/2609.20497)
...
### [30] [PixelFlow: Token-Level Workload Management for Efficient Distributed DiT Serving](https://arxiv.org/abs/2609.20723)
